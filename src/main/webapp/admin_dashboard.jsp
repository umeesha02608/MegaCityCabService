...
<body>
    <div class="container mt-4">
        ...
        <div class="list-group">
            <a href="manage_customers.jsp" class="list-group-item list-group-item-action">Manage Customer</a>
            ...
            <a href="manage_drivers.jsp" class="list-group-item list-group-item-action">Manage Drivers</a>
